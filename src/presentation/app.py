...
def render_dashboard(product_service: ProductService, price_service: PriceService):
    ...
    st.markdown(
        """##### Track product prices across e-commerce sites and get Discord notifications when prices drop. See setup instructions in the [GitHub repo](https://github.com/Jaspeeetkaur/PricePulse-Ecommerce-Price-Tracker). View my tracked products below.
        """
    )
